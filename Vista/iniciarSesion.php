...
<form id="form1" name="form1" method="post" action="../controlador/validarInicioSesion.php">
  <table bgcolor="#CCFFFF" width="31%" border="0" align="center">
    <tr bgcolor="#CCCC00">
      <td colspan="2" align="center" bgcolor="#339966" class="texto" >Inicio Sesión</td>
    </tr>
    <tr>
      <td bgcolor="#CCFFFF" width="39%" align="right">Login</td>
    ...
    <tr>
      <td colspan="2" align="center" bgcolor="#339966"><input type="submit" name="button" id="button" value="Enviar" /></td>
    </tr>
  </table>
</form>
