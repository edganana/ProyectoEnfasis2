...
<p>
<form action="../controlador/validarfrmInsertarFoto.php"method="POST" enctype= "multipart/form-data">
<center><table bgcolor="#D0F5A9" border="1">
<tr>
<tr>
      <td colspan="2" align="center" valign="middle" bgcolor="#339966"><div align="center">INSERTAR_RUTA_FOTOS </div></td>
 </tr>   
